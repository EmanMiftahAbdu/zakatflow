...
@app.get("/test-plaid", response_class=HTMLResponse, include_in_schema=False)
async def test_plaid_page():
    """Serve the Plaid integration test page (dev only)."""
    html_path = Path(__file__).resolve().parent.parent.parent / "test-plaid.html"
